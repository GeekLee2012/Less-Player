...
public final class MainView extends PlayerView {
	...
	//TODO
	private DndHandle initDndHandle() {
		if(dndHandle != null) {
			return dndHandle;
		}
...
//		graphic.setPreserveRatio(true);
	...
	private void loadLyric(Audio audio) {
		...
		String uri = source.substring(0, index) + ConfigConstant.LYRIC_SUFFIXES[0];
