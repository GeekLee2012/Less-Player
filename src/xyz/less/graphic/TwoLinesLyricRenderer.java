...
public class TwoLinesLyricRenderer {
	...
	private Runnable noLyricAction = () -> setNoLyricText();
	...
	public boolean hasLyricDatas() {
		return isCurrentAudioExist() && !timeKeyList.isEmpty();
	}
	
	private boolean isCurrentAudioExist() {
		return AppContext.get().getCurrent() != null;
	}
